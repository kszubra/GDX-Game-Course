package com.gdx.game.course.avoidobstacle.util.debug;
...
public class DebugCameraController {
    ...
    private void setZoom(float value) {
        zoom = MathUtils.clamp(value, config.getMaxZoomIn(), config.getMaxZoomOut()); //clamp ensures value doesn't go beyond min and max
    }
    ...
    private void logDebug() {
        log.debug(String.format("position: %s, zoom: %s", position, zoom));
    }
}
